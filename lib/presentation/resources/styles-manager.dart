...
import 'package:mvvmapp/presentation/resources/font-manager.dart';

TextStyle _getTextStyle(
    {required double fontSize, required FontWeight fontWeight, required String fontFamily , required Color color}) {
  return TextStyle(
    fontSize: fontSize,
